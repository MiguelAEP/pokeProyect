...
const Ground = ({setCargando,setPokeGround,pokeGround}) => {

  
  useEffect(() => {

    const getGround = async () => {
      let API = `https://pokeapi.co/api/v2/type/ground/`
      ...
      data.pokemon.forEach(async (element) => {
        ...
        setPokeGround((pokeGround) => [...pokeGround, pokemon]);
